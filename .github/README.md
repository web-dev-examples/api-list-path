...
[file__package_json]:
  https://github.com/web-dev-examples/blob/main/package.json

[file__gitignore]:
  https://github.com/web-dev-examples/blob/main/.github

[file__tsconfig_json]:
  https://github.com/web-dev-examples/blob/main/tsconfig.back-end.json

[file__tsconfig_back_end_json]:
  https://github.com/web-dev-examples/blob/main/tsconfig.back-end.json

[file__tsconfig_front_end_json]:
  https://github.com/web-dev-examples/blob/main/tsconfig.front-end.json

[file__tsconfig_jest_json]:
  https://github.com/web-dev-examples/blob/main/tsconfig.jest.json

[file__jest_back_end_json]:
  https://github.com/web-dev-examples/blob/main/jest.back-end.json

[file__jest_front_end_json]:
  https://github.com/web-dev-examples/blob/main/jest.front-end.json


[directory__backend]:
  https://github.com/web-dev-examples/tree/main/back-end

[directory__ts__backend]:
  https://github.com/web-dev-examples/tree/main/ts/back-end

[file__ts__back_end__index_ts]:
  https://github.com/web-dev-examples/blob/main/ts/back-end/index.ts

[file__ts__back_end__routes__index_ts]:
  https://github.com/web-dev-examples/blob/main/ts/back-end/routes/index.ts

[file__ts__back_end__routes__list__post_ts]:
  https://github.com/web-dev-examples/blob/main/ts/back-end/routes/list/post.ts


[directory__ts__jest]:
  https://github.com/web-dev-examples/tree/main/ts/jest

[file__ts__jest__back_end__index_ts]:
  https://github.com/web-dev-examples/blob/main/ts/jest/back-end/index.ts

[file__ts__jest__front_end__index_ts]:
  https://github.com/web-dev-examples/blob/main/ts/jest/front-end/index.ts


[directory__front_end]:
  https://github.com/web-dev-examples/tree/main/front-end

[file__front-end__index_html]:
  https://github.com/web-dev-examples/blob/main/front-end/index.html


[directory__ts__front_end__assets__js]:
  https://github.com/web-dev-examples/tree/main/ts/front-end/assets/js

[file__ts__front-end__assets__js__index_ts]:
  https://github.com/web-dev-examples/blob/main/ts/front-end/assets/js/index.ts
